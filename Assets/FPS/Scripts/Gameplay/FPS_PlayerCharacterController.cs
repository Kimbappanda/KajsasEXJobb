...
namespace Unity.FPS.Gameplay
{
    ...
    public class FPS_PlayerCharacterController : MonoBehaviour
    {
...
//        public float CameraHeightRatio = 0.9f;
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<CharacterController, FPS_PlayerCharacterController>(m_Controller,
                this, gameObject);

            m_InputHandler = GetComponent<PlayerInputHandler>();
            DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler, FPS_PlayerCharacterController>(m_InputHandler,
                this, gameObject);

            m_WeaponsManager = GetComponent<PlayerWeaponsManager>();
            DebugUtility.HandleErrorIfNullGetComponent<PlayerWeaponsManager, FPS_PlayerCharacterController>(
            ...
            DebugUtility.HandleErrorIfNullGetComponent<Actor, FPS_PlayerCharacterController>(m_Actor, this, gameObject);
